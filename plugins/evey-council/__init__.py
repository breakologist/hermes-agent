...
# Serial council: ollama loads one model at a time into VRAM
COUNCIL_MODELS = [
    "qwen2.5:7b-instruct",     # Slot 1: fast reasoning (4.7GB)
    "lelantos-7b",              # Slot 2: creative DPO (7.2GB)
    "qwen3.5-9b-heretic",       # Slot 3: uncensored (8.9GB)
]
...
SCHEMA = {
    ...
    "description": (
        ...
        "model provides. Zero cost — all local models. Serial loading via ollama."
    ),
    "parameters": {
        "type": "object",
        "properties": {
