...
# Ensure plugin environment has access to Hermes .env (best-effort)
# This makes plugins robust when run in isolation (cron, sub-agents, debugging)
try:
    ...
    pass  # Silently continue; actual API errors will surface when tools are called
