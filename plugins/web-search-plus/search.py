...
# Load Hermes .env so API keys are available when this script runs as a subprocess
# This ensures search.py can see keys even if the parent process didn't load dotenv
try:
    ...
    pass  # Continue without dotenv; upstream errors will indicate missing keys
